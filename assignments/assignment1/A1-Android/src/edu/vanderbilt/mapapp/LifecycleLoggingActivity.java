...
/**
 * @class LifecycleLoggingActivity
 *
 * @brief LifeCycleLoggingActivity is an abstract class that extends
 *        Activity class and overrides lifecycle callbacks for logging
